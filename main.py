...
words = ["веселка", "крига", "корпус", "їжа", "алея", "кіт", "метал", "мова", "вікно", "яйце", "пісня", "народ", "казка", "немовля", "літра", "підлога", "деревина", "око", "абетка", "лист", "підряпина", "крапка", "перо", "цукерка", "земля", "соняшник", "кімната", "ліжко", "годинник", "час", "година", "хвилина", "рік", "літо", "березень", "їжак", "світло", "мікрофон"]
word = choice(words)
spisok = []
